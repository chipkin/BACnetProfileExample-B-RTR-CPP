...
Measured from the [v1.0.0](https://github.com/chipkin/BACnetProfileExample-B-RTR-CPP/releases/tag/v1.0.0) release CI.

| Metric | Windows | Linux |
|---|---|---|
| Binary size | 3,263,488 bytes | 49,128 bytes |
| SHA-256 (prefix) | `688a49a7a1ca5fb2` | `8842ac2760185932` |
| Start-up time to `ready` | 200 ms | 109 ms |
| Stack commit | `abd4cee1` (6.0.21) | `abd4cee1` (6.0.21) |
| Link mode | STATIC | STATIC |
| Compiler | Visual Studio 17 2022 | `/usr/bin/c++` |

v1.0.0 was published from a STATIC-linked build; this table now documents the
adapter's default **SOURCE** mode instead (see [Build](#build)), so the next
release refreshes these numbers from the documented build.
...
- **A BACnet client for testing this device** - [bacpypes3](https://github.com/JoelBender/bacpypes3)
  or [YABE](https://sourceforge.net/projects/yetanotherbacnetexplorer/).
